#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/refs/heads/feature/kde-desktop/misc/build.func)
...
function update_script() {
  ...
  msg_info "Updating KDE Desktop"
  $STD apt update
  $STD apt upgrade -y
  msg_ok "Updated KDE Desktop"
