...
ADDON_SCRIPT="https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/tools/addon/runtipi.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/tools/addon/runtipi.sh)"
MIGRATION_EOF
