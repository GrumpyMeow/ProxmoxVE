...
ADDON_SCRIPT="https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/tools/addon/coolify.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/tools/addon/coolify.sh)"
MIGRATION_EOF
