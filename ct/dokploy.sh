...
ADDON_SCRIPT="https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/tools/addon/dokploy.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/tools/addon/dokploy.sh)"
MIGRATION_EOF
