...
ADDON_SCRIPT="https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/tools/addon/komodo.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/tools/addon/komodo.sh)"
MIGRATION_EOF
