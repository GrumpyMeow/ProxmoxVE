...
ADDON_SCRIPT="https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/tools/addon/dockge.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/tools/addon/dockge.sh)"
MIGRATION_EOF
