...
function update_script() {
  ...
  if [[ $(grep -E '^VERSION_ID=' /etc/os-release) == *"12"* ]]; then
    ...
    msg_error "Please create a snapshot first. You must upgrade your LXC to Debian Trixie before updating. Visit: https://github.com/GrumpyMeow/ProxmoxVE/discussions/7489"
    exit
  fi
