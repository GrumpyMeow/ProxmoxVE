...
```bash
#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/misc/install.func)
...
- [Trip](https://github.com/GrumpyMeow/ProxmoxVE/blob/main/install/trip-install.sh)
- [Thingsboard](https://github.com/GrumpyMeow/ProxmoxVE/blob/main/install/thingsboard-install.sh)
- [UniFi](https://github.com/GrumpyMeow/ProxmoxVE/blob/main/install/unifi-install.sh)
