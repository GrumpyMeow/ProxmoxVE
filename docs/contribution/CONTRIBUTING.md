...
- Use [AppName.sh](https://github.com/GrumpyMeow/ProxmoxVE/blob/main/docs/contribution/templates_ct/AppName.sh) and [AppName-install.sh](https://github.com/GrumpyMeow/ProxmoxVE/blob/main/docs/contribution/templates_install/AppName-install.sh) as templates when creating new scripts.

---

# 🚀 The Application Script (ct/AppName.sh)

- You can find all coding standards, as well as the structure for this file [here](https://github.com/GrumpyMeow/ProxmoxVE/blob/main/docs/contribution/templates_ct/AppName.md).
...
- You can find all coding standards, as well as the structure for this file [here](https://github.com/GrumpyMeow/ProxmoxVE/blob/main/docs/contribution/templates_install/AppName-install.md).
...
Start with the [template script](https://github.com/GrumpyMeow/ProxmoxVE/blob/main/docs/contribution/templates_install/AppName-install.sh)
...
dev_mode="trace,keep" bash -c "$(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/ct/myapp.sh)"
```
...
- [CT Template: AppName.sh](https://github.com/GrumpyMeow/ProxmoxVE/blob/main/docs/contribution/templates_ct/AppName.sh)
- [Install Template: AppName-install.sh](https://github.com/GrumpyMeow/ProxmoxVE/blob/main/docs/contribution/templates_install/AppName-install.sh)
- [JSON Template: AppName.json](https://github.com/GrumpyMeow/ProxmoxVE/blob/main/docs/contribution/templates_json/AppName.json) — metadata structure reference; submit via the website (Report issue on script page)
