...
# upstream   https://github.com/GrumpyMeow/ProxmoxVE.git (fetch)
# upstream   https://github.com/GrumpyMeow/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/GrumpyMeow/ProxmoxVE"
echo ""
