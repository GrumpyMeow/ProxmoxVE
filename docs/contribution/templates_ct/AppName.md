...
```bash
#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/misc/build.func)
...
- [Trip](https://github.com/GrumpyMeow/ProxmoxVE/blob/main/ct/trip.sh)
- [Thingsboard](https://github.com/GrumpyMeow/ProxmoxVE/blob/main/ct/thingsboard.sh)
- [UniFi](https://github.com/GrumpyMeow/ProxmoxVE/blob/main/ct/unifi.sh)
