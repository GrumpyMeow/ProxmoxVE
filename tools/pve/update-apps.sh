...
source <(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/refs/heads/main/misc/core.func)
...
for container in $CHOICE; do
  ...
  script=$(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/ct/${service}.sh)
