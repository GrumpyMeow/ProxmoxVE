...
source <(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/misc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/misc/tools.func)
source <(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/misc/error_handler.func)
source <(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/misc/api.func) 2>/dev/null || true
...
type=update bash -c "$(curl -fsSL https://raw.githubusercontent.com/GrumpyMeow/ProxmoxVE/main/tools/addon/prometheus-paperless-ngx-exporter.sh)"
UPDATEEOF
